...
const Login = (props) => {
  ...
  const login = useGoogleLogin({
    onSuccess: function(codeResponse){
        ...
        navigate("/home", { state: codeResponse });
    },
        ...
        <main className="w-full h-screen flex flex-col items-center justify-center bg-gray-50 sm:px-4">
                <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                    <div className="text-center">
                        <img src="talkie.png" width={50} className="mx-auto" />
                    ...
                    <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                        <div className="grid grid-cols-3 gap-x-3">
                            <button onClick={login} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
